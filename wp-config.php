...
$params = [
    ...
    'db_host' => getenv('DB_WORDPRESS_HOST'),
    'wp_site_url' => getenv('WP_SITEURL'),
...
if ($siteUrl = ($params['wp_site_url'] ?? false)) {
    define('WP_SITEURL', $params['wp_site_url']);
    define('WP_HOME', $params['wp_home']);
}
